...
//    }
    private void initGameView(){
        ...
        Config.CARD_WIDTH=(displayMetrics.widthPixels-40)/ Config.LINES;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Config.CARD_WIDTH=(Math.min(w,h)-Config.MARGINS)/4;
    ...
    private void addRandomNum(int t){
        ...
        while (t-->0){
            ...
            if (emptyPoints.size()>0){
                ...
                cardsMap[p.x][p.y].setNum(Math.random()>0.15?2:4);
